...
export default function CurrencyDollarIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M10.464 8.746c.227-.18.497-.311.786-.394v2.795a2.3 2.3 0 0 1-.786-.393c-.394-.313-.546-.681-.546-1.004s.152-.691.546-1.004M12.75 15.662v-2.824c.347.085.664.228.921.421.427.32.579.686.579.991s-.152.671-.579.991a2.5 2.5 0 0 1-.921.42" />
      <path
        fillRule="evenodd"
